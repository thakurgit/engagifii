		...
		if(is_array($options) && !empty($options))
		{
			...
			if($module == 'legislation' || $module == 'legislation-auth'){
				...
				if (isset($_COOKIE['peopleToken'])) {
					...
					$authentication = 'authorization: Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6IjczQ0Q4NERGRUJGQzk4NUU4RUZGOTU0QjY2NTg0OEFBMTYzNDExNkIiLCJ0eXAiOiJKV1QiLCJ4NXQiOiJjODJFMy12OG1GNk9fNVZMWmxoSXFoWTBFV3MifQ..IaqaXWBwLl6aBJO9ROQebnJF8NE83S4JD_OJIF4f2D2XeLZcBw8MXKrqzHOeDtKkkvtHoKb3ZmfPOduVAK7Rd3K2fCCbktj0EzHMuEuyvJvpvxnwaMyzAu2g4EMecIVh5A014P4MFnIiQf8cFnjQOBvtZhBOnrHsbugCQQ8TlZAI6Fz4dM69gZ_E_xF4Jel676kKBAdOtAkujerlyYTwIGlXQOLR1kGCIH50FMHKA4UbNgYPqpWTlph6AGgcsX7Y1adK3mBz2wmP6r68dv4coO5XlTNsrxIzXBjHM7070w4PqDT2mMkSzU6J4oZRWwLbK3a3JXtRkpMsZzFPgyMVVg';
				}
...
return $this->submitApiRequestWithGet($apiUrl,$postData, 'legislation'); 
	...
	public function getFiscalYear(){
		$postData=json_decode('{"sortBy":"name","pageNumber":1,"isAscending":true,"isCount":true,"pageSize":10}');
		$responseArray = array();
		$apiUrl = 'qb/integration/get/fiscalyearlist';
		$response =  $this->submitApiRequest($apiUrl, $postData, 'POST', 'revenue');
		$responseArray = json_decode($response['api_response'], true);
		return $response;
	}

	public function creditEarnedCount($profileId, $fiscalStartDate, $fiscalEndDate){
		$postData=array();
		$responseArray = array();
...
//end here
	...
	public function getUserPermissions($tenantCode, $loggedInUserId) {
