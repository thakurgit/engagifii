            ...
            <div class="row">
            	...
            	<div class="col-3"><strong>County: </strong><?php echo $response->counties[0]->countyName; 
					if(count($response->counties) > 1){
						echo ' <span class="dropdown dropright"><a type="button" data-toggle="dropdown">+'.count($response->counties) .' more</a><div class="dropdown-menu py-0"><ul class="list-group list-group-flush">';	
