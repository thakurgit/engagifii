            ...
            if(response!= 'no-data') {
                ...
                obj.forEach(function(value, index) {
                   ...
                   else if(calendar_view == 'week')
                   {
                    ...
                    class_html += '<div class="'+html_class+' mb-3  "><div class="box border rounded h-100 class-text bg-light"><div class="col-12 m-auto p-1 text-left d-flex align-items-center"><img src="'+value['icon']+'" class="img-fluid img-icon-lg mr-2">'+value['title']+'</div><?php if(in_array('eventDates', $events_visible_column_list)) { ?><div class="col-12 py-1 text-left">'+value["schedule"]+'</div><?php } if(in_array('eventType', $events_visible_column_list)){ ?><div class="col-12 py-1 text-left"><span class="text-muted">Type: </span><span>'+value["objectType"]+'</span></div><?php } ?> <div class="col-12 py-1 text-left"><span class=" text-muted">Price: $</span><span>'+value["price"]+'</span></div><?php if(in_array('tags', $events_visible_column_list)){ ?><div class="col-12 py-1 text-left"><span class=" text-muted">Tags: </span><span>'+tags+'</span></div><?php } ?><div class="col-12 text-center py-3">'+value['viewdetails']+' <?php if(in_array('register', $events_visible_column_list)){ ?> '+value['register']+'</div><?php } ?></div></div>';
