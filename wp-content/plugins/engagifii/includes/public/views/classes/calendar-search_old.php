...
<table class="table calendarlist"> 
<?php
    $classData = array();
...
foreach ($result2 as $key => $res) { 
    ...
    <tr>        
        <?php if($classDate==$todayDate){ ?>
            <th scope="row"><span class="dayofmonth" id="dayofmonth"><?php echo date('j', strtotime($classDate)).' '; ?> </span> <?php echo date("M Y", strtotime($classDate));?></th>
       <?php } else { ?>
    <th scope="row"><span ><?php echo date('j', strtotime($classDate)).' '; ?> </span> <?php echo date("M Y", strtotime($classDate));?></th>
    <?php } ?>
    <td>
<?php
...
?>
    <a data-toggle="modal" data-target="#exampleModal2<?php echo $data['classId'];echo $i; ?>" href="" style="color:black !important; font-size:smaller;" >
     <li ><?php echo $data['startTime']; echo "  -  ".$data['endTime'];?></span>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style ="color:black;">
                    <p><strong>Date :</strong> <?php echo date("j M Y", strtotime($data['date'])).' '; echo $data['startTime']; echo "  -  ".$data['endTime'];?></p>
