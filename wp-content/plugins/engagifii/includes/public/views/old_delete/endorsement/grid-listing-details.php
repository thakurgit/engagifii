...
<div class="engagifii-box border border-bottom-0">
    <div class="col-sm-12 d-flex p-2">
        <div class="col-md-1 col-sm-2 pt-3">
            <img class="img-circle" src="<?php echo $endResponses->icon;?>">
        </div>
        ...
        <div class="col-md-2 col-sm-12 pull-right">
          <div class="clearfix">
            <a href="<?php echo site_url();?>/endorsement-grid-view/" class="pull-right pl-2 close-link text-muted"></a>
            <!-- <a href="#" class="pull-right pl-2 pr-2 next-link text-muted"></a>
            <a href="#" class="pull-right pr-2 previous-link text-muted"></a> -->
          </div>
          <div class="clearfix pt-4">
            <a class="btn btn-primary pull-right" href="<?php echo $tenant_url;  ?>/pages/awards/<?php echo $endId; ?>/signup/overview" target="_blank">Register</a>
          </div>
