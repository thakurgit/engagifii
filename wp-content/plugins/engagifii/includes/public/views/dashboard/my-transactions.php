...
<?php echo do_shortcode('[dashboard_nav]'); ?>
  ...
  <li class="nav-item" role="presentation">
    <button class="nav-link px-0 mx-3 border-0 bg-transparent active" id="home-tab" data-toggle="tab" data-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Transactions</button>
  </li>
  <li class="nav-item" role="presentation">
...
$tabs = ['Invoices','Payments','Due','Overdue','Credits', 'Refunds'];
