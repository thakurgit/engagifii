...
<?php } ?>
  ...
  <div class="d-flex justify-content-between align-items-center mb-3">
   <button type="button" title="Refresh Downloads" class="refresh btn shadow-none p-2"> <i class="fas fa-sync"></i></button><?php echo '<img src="'.ENGAGIFII_ASSETS_URL.'/images/class.png" class="img-icon-lg img-fluid" alt="class-icon" >'; ?>
