...
<ul class="nav nav-tabs profile-tabs mb-4" id="myTab" role="tablist">
  ...
  <div class="tab-pane fade border bg-light rounded-2 p-4 show active" id="nav-header" role="tabpanel" aria-labelledby="nav-home-tab">
    ...
    <span class="position-absolute w-100 h-100 top-0 start-0 text-white d-flex align-items-center flex-column justify-content-center" style="background:rgba(0,0,0,0.6); opacity:0"><i class="fa fa-image"></i><br>Upload</span>
