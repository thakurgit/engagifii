...
function ebt_api_shortocde_description(){
	...
	echo "<ul class='list'><li>Endorsement List <strong>[endorsement-grid-list]</strong></li> <li>Endorsement Detail <strong>[endorsement-details Id='endorsement-id']</strong></li><li>Endorsement Calendar <strong>[endorsement-list-calendar]</strong></li> </ul>";
	echo "</div>";
  ...
  echo "<div class='engagifii-setting'>";
  echo "<ul class='list'><li>Class List <strong>[classes-list]</strong></li><li>Class Details <strong>[class-details Id='class-id']</strong></li><li>Class Calendar <strong>[class-calendar]</strong></li><li>Class List & Calendar <strong>[classes-list-calendar calendar=true]</strong></li></ul>";
...
function ebt_tenant_code_render(  ) {
	...
	function lbt_tenant_code_render(  ) {
      ...
      if(isset($options['lbt_tenant_code'])){
    	...
    	$_inputHtml = '<input type="text"  class="postbox"  name="ebt_api_settings[lbt_tenant_code][engagifii_url]" value="'.$engagifii_url.'" onkeyup="getTenantCode(this.value)">&nbsp;&nbsp;<strong>Tenant Code:</strong><span id="lbt_tenantcode_preview">'.$code.'</span>';
      	echo $_inputHtml.$_inputHtmlHidden;
	}
