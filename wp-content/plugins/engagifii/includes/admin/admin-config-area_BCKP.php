...
function ebt_api_shortocde_description(){
	...
	echo "<ul class='list'><li>Endorsement List <strong>[endorsement-grid-list]</strong></li> <li>Endorsement Detail <strong>[endorsement-details Id='endorsement-id']</strong></li></ul>";
	echo "</div>";
